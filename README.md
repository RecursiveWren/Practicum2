...
# Building the Models    
Using a 2-D Keras sequential model, incorporating 2 dense layers set to 43 and 512, wherein Activation = relu and Loss = categorical crossentropy, I tested the impact made by the optimizer to the model’s performance. Thus I only changed the optimizers, testing the following three:    
